...
- [x] AssessmentCubit manages state
- [x] AssessmentService handles business logic
...
- [x] Step 1: Create AssessmentCubit
- [x] Step 2: Refactor AssessmentService
- [x] Step 3: Update AssessmentScreen
- [x] Step 4: Delete old controller
- [x] Step 5: Test assessment flow
